...
@section('container')
    <h2 style="text-align: center"> Menambah Data Mahasiswa </h2>
    <center>
          ...
          <table class="table table-striped">
            <div class="row">
                <form id="edit_layanan" action="" method="post" enctype="multipart/form-data">
                    ...
                    <p class="card-text">Anda akan menambah data mahasiswa ke dalam daftar mahasiswa yang mengambil mata kuliah Pembangunan Perangkat Lunak</p>
                    <div class="container">
                      <div class="row">
                        <div class="col">
