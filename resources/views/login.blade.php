...
@section('container')
    <center>
        ...
        >
            ...
            <div class="card text-white mt-100" style="width: 480px; height:auto; max-height:auto; background-color: #1F2261; border-radius: 50px; margin: 70px 0 0 0; padding: 0 50px 0 50px">
                <div class="card-body">
                  ...
                  <form action="/proseslogin" method = "POST" class="card-text" style="text-align: left"> <br>
                    ...
                    <div class="la" style="text-align: left; margin:10px 0 0 0;">
                      ...
                      <input type="password" name="password" class="form-control" placeholder="Masukkan password dengan benar" ><br><br>
